      ...
      html: `
        <div style="font-family: Arial, sans-serif; background: #fff; border-radius: 12px; box-shadow: 0 2px 8px #ec960820; padding: 32px; max-width: 480px; margin: auto;">
          <div style="text-align: center; margin-bottom: 24px;">
            ...
            <h2 style="color: #ec9608; margin: 0; font-size: 1.5rem;">New Volunteer Application</h2>
          </div>
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
            <tr><td style="font-weight: bold; color: #ec9608; padding: 8px 0;">Name:</td><td style="padding: 8px 0;">${name}</td></tr>
            ...
            <tr><td style="font-weight: bold; color: #ec9608; padding: 8px 0;">Interest:</td><td style="padding: 8px 0;">${interest || '-'}</td></tr>
          </table>
          <div style="background: #ec960810; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
            <h3 style="color: #ec9608; margin-top: 0; font-size: 1.1rem;">Motivation & Message</h3>
            <p style="margin: 0; color: #222;">${message.replace(/\n/g, '<br/>')}</p>
          </div>
          <div style="text-align: center; color: #888; font-size: 0.9rem; margin-top: 24px;">
            <em>This message was sent via the Manomitra website volunteer form.</em>
          </div>
        </div>
      `
    });
